    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="flex justify-end m-2 p-2">
          <Link href="/admin/medicines/index" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white rounded">
          Back
          </Link>
        </div>
        ...
        <div v-if="isExisting"
          class="fixed top-50 left-10 bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 w-80 shadow-lg rounded-lg z-50">
              ...
              <div class="grid md:grid-cols-3 md:gap-3">
                <div class="relative z-0 w-full mb-1 group">
                  <input v-model="form.lprice" type="number" name="lprice" id="lprice"
                    class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" " required :readonly="isExisting" />
                  <label for="lprice"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Lowest
                    Price</label>
                </div>
                <div class="relative z-0 w-full mb-1 group">
                ...
                <div class="relative z-0 w-full mb-5 group">
                  <input v-model="form.hprice" type="number" name="hprice" id="hprice"
                    ...
                    placeholder=" " required :readonly="isExisting" />
                  <label for="hprice"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Highest
                    Price</label>
                </div>
              </div>
              ...
              <div class="grid md:grid-cols-3 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-5 group">
                  <input v-model="form.expdate" type="date" name="expdate" id="expdate"
                    ...
                    placeholder=" " required />
                  <label for="expdate"
                    class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Expiration
                    Date</label>
                </div>
              </div>
